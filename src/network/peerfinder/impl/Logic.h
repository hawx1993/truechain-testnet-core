...
#ifndef SKYWELL_PEERFINDER_LOGIC_H_INCLUDED
#define SKYWELL_PEERFINDER_LOGIC_H_INCLUDED
...
public:
    ...
    // A set of unique Skywell public keys
    typedef std::set <SkywellPublicKey> Keys;
    ...
    */
    ...
    activate (SlotImp::ptr const& slot,
        SkywellPublicKey const& key, bool cluster)
    {
        if (m_journal.debug) m_journal.debug << beast::leftw (18) <<
