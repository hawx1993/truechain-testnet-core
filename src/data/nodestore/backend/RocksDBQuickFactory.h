...
#ifndef SKYWELL_APP_DATA_NODESTORE_ROCKSDBQUICKFACTORY_H_INCLUDED
#define SKYWELL_APP_DATA_NODESTORE_ROCKSDBQUICKFACTORY_H_INCLUDED
...
#endif //SKYWELL_ROCKSDB_AVAILABLE endif
