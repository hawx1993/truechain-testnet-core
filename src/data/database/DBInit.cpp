...
const char* WalletDBInit[] =
{
    ...
    // Fetches are made to the CAS.  This gets the truechain.txt so even validators
    // without a web server can publish a truechain.txt.
    // Source:
    //  'M' = Manually added.   : 1500
    //  'V' = validators.txt    : 1000
    //  'W' = Web browsing.     :  200
    ...
    // Referral:
    //  This is the form provided by the truechain.txt:
    ...
    // List of referrals from truechain.txt files.
    // Validator:
