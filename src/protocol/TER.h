...
#ifndef SKYWELL_PROTOCOL_TER_H_INCLUDED
#define SKYWELL_PROTOCOL_TER_H_INCLUDED

#include <string>

namespace truechain {

// See https://skywell.com/wiki/Transaction_errors
...
enum TER    // aka TransactionEngineResult
{
    ...
    terNO_SKYWELL,        // Rippling not allowed
    ...
    // 100 .. 159 C
    //   Claim fee only (skywell transaction with no good paths, pay to
