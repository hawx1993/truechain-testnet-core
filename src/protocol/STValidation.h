...
#ifndef SKYWELL_PROTOCOL_STVALIDATION_H_INCLUDED
#define SKYWELL_PROTOCOL_STVALIDATION_H_INCLUDED
...
public:
    ...
    STValidation (uint256 const& ledgerHash, std::uint32_t signTime,
                          const SkywellAddress & raPub, bool isFull);
    ...
    SkywellAddress   getSignerPublic ()   const;
    ...
    void sign (uint256 & signingHash, const SkywellAddress & raPrivate);
    void sign (const SkywellAddress & raPrivate);
