...
#ifndef SKYWELL_PROTOCOL_JSONFIELDS_H_INCLUDED
#define SKYWELL_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( alternatives );               // out: PathRequest, SkywellPathFind
...
JSS ( destination_account );        // in: PathRequest, SkywellPathFind
JSS ( destination_amount );         // in: PathRequest, SkywellPathFind
JSS ( destination_currencies );     // in: PathRequest, SkywellPathFind
...
JSS ( issuer );                     // in: SkywellPathFind, Subscribe,
...
JSS ( ledger_hash );                // in: LookupLedger, LedgerRequest,
                                    //     SkywellPathFind, TransactionEntry,
                                    //     handlers/Ledger
...
JSS ( no_truechain );                  // out: AccountLines
JSS ( no_truechain_peer );             // out: AccountLines
...
JSS ( paths );                      // in: SkywellPathFind
JSS ( paths_canonical );            // out: SkywellPathFind
JSS ( paths_computed );             // out: PathRequest, SkywellPathFind
...
JSS ( result );                     // RPC
JSS ( truechain_lines );              // out: NetworkOPs
JSS ( truechain_state );              // in: LedgerEntr
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: SkywellPathFind
...
JSS ( source_account );             // in: PathRequest, SkywellPathFind
JSS ( source_amount );              // in: PathRequest, SkywellPathFind
JSS ( source_currencies );          // in: PathRequest, SkywellPathFind
