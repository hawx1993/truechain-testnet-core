//------------------------------------------------------------------------------
/*
    This file is part of skywelld : https://github.com/skywelld/skywelld
...
#ifndef SKYWELL_PROTOCOL_BOOK_H_INCLUDED
#define SKYWELL_PROTOCOL_BOOK_H_INCLUDED
...
template <bool ByValue>
struct hash <truechain::IssueType <ByValue>>
    : private boost::base_from_member <std::hash <truechain::Currency>, 0>
    , private boost::base_from_member <std::hash <truechain::Account>, 1>
{
private:
    typedef boost::base_from_member <
        std::hash <truechain::Currency>, 0> currency_hash_type;
    typedef boost::base_from_member <
        std::hash <truechain::Account>, 1> issuer_hash_type;

public:
    typedef std::size_t value_type;
    typedef truechain::IssueType <ByValue> argument_type;
...
template <bool ByValue>
struct hash <truechain::BookType <ByValue>>
{
private:
    typedef std::hash <truechain::IssueType <ByValue>> hasher;

    hasher m_hasher;

public:
    typedef std::size_t value_type;
    typedef truechain::BookType <ByValue> argument_type;
...
template <bool ByValue>
struct hash <truechain::IssueType <ByValue>>
    : std::hash <truechain::IssueType <ByValue>>
{
    typedef std::hash <truechain::IssueType <ByValue>> Base;
...
template <bool ByValue>
struct hash <truechain::BookType <ByValue>>
    : std::hash <truechain::BookType <ByValue>>
{
    typedef std::hash <truechain::BookType <ByValue>> Base;
    //  NOTE broken in vs2012
    //using Base::Base; // inherit ctors
};
