...
#ifndef SKYWELL_PROTOCOL_STOBJECT_H_INCLUDED
#define SKYWELL_PROTOCOL_STOBJECT_H_INCLUDED
...
public:
    ...
    SkywellAddress getFieldAccount (SField const& field) const;
    ...
    */
    ...
    void setFieldAccount (SField const& field, SkywellAddress const& addr)
    {
