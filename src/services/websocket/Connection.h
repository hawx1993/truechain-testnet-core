...
#ifndef SKYWELL_APP_WEBSOCKET_WSCONNECTION_H_INCLUDED
#define SKYWELL_APP_WEBSOCKET_WSCONNECTION_H_INCLUDED
...
/** A Skywell WebSocket connection handler.
*/
template <class WebSocket>
...
{
    WriteLog (lsDEBUG, ConnectionImpl)
