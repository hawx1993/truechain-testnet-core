...
void truechain::RPC::RPCInfo::reset()
{
   mAPIInfo.clear();
   mRPCInfo.clear();
   mRPCError.clear();
...
//
void truechain::RPC::RPCInfo::updateError(Json::Value const& inCommand ,Json::Value const& inError,bool isrpc)
{
...
void truechain::RPC::RPCInfo::updateCmd(Json::Value const& inCommand ,bool isrpc)
{
  auto const& cmd = getCmd(inCommand);
...
void truechain::RPC::RPCInfo::update(info_map_type& mInfo,std::string const& cmdkey,std::string const& tycmd)
{	
...
std::tuple<std::string,std::string> truechain::RPC::RPCInfo::getCmd(Json::Value const& inCommand)
{
...
void truechain::RPC::RPCInfo::printInfo(Json::Value const& inCommand,Json::Value const& inError,bool isrpc)
{
...
Json::Value truechain::RPC::RPCInfo::errToJson(std::string const&cmd,info_map_type &mErr,unsigned int& count)
{
...
Json::Value truechain::RPC::RPCInfo::dataTojson(info_map_type& mCmd,info_map_type& mErr)
{
...
Json::Value truechain::RPC::RPCInfo::show()
{
   Json::Value jvResult (Json::objectValue);
