...
#ifndef SKYWELL_APP_BOOK_QUALITY_H_INCLUDED
#define SKYWELL_APP_BOOK_QUALITY_H_INCLUDED
...
// Skywell specific constant used for parsing qualities and other things
