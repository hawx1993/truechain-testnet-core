...
#ifndef SKYWELL_APP_PATHS_PATHREQUESTS_H_INCLUDED
#define SKYWELL_APP_PATHS_PATHREQUESTS_H_INCLUDED
...
public:
    ...
    SkywellLineCache::pointer getLineCache (
...
private:
    ...
    // Use a SkywellLineCache
    SkywellLineCache::pointer         mLineCache;
