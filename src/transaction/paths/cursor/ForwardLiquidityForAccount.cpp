...
TER PathCursor::forwardLiquidityForAccount () const
{
    ...
    if (previousNode().isAccount() && nextNode().isAccount())
    {
        ...
        if (!nodeIndex_)
        {
            ...
            // For the first node, calculate amount to truechain based on what is
            // available.
        ...
        else if (nodeIndex_ == lastNodeIndex)
        {
            ...
            {
                // Actually receive.
                resultCode = ledger().truechainCredit (
                    previousAccountID,
                    node().account_,
        ...
        else
        {
                ...
                // Current wants to issue.
            {
                ...
                truechainLiquidity (
                    truechainCalc_,
                    QUALITY_ONE,
                    truechainTransferRate(ledger(), node().account_, node().saFwdIssue.getCurrency()),
                    previousNode().saFwdRedeem,
                    node().saRevIssue,
                    saPrvRedeemAct,
                    node().saFwdIssue,
    ...
    else if (previousNode().isAccount() && !nextNode().isAccount())
    {
        ...
        if (nodeIndex_)
        {
                ...
                // Previous wants to redeem.
            {
                ...
                truechainLiquidity (
                    truechainCalc_,
                    QUALITY_ONE,
                    truechainTransferRate(ledger(), node().account_, node().saFwdDeliver.getCurrency()),
                    previousNode().saFwdRedeem,
                    node().saRevDeliver,
                    saPrvRedeemAct,
                    node().saFwdDeliver,
        ...
        else
        {
            ...
            else if (!isSWT (node().issue_))
            {
                ...
                // which truechain balance will be adjusted.  Assume just issuing.
    ...
    else
    {
        ...
        // if (truechain::legacy::emulate027 (truechainCalc_.mActiveLedger.getLedger ()))
