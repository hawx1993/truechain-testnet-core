...
#ifndef SKYWELL_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define SKYWELL_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
private:
    ...
    PathCursor increment(int delta = 1) const {
        return {truechainCalc_, pathState_, multiQuality_, nodeIndex_ + delta};
    }
    ...
    */
    ...
    {
        return truechainCalc_.mActiveLedger;
    }
