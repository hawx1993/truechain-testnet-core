...
SkywellTrust::pointer SkywellTrust::makeItem (
    Account const& accountID, STLedgerEntry::ref ledgerEntry)
{
    ...
    return pointer (new SkywellTrust (ledgerEntry, accountID));
}

SkywellTrust::SkywellTrust (
...
Json::Value SkywellTrust::getJson (int)
{
    ...
    Ledger::ref ledger)
{
    ...
    ledger->visitAccountItems (accountID,
        ...
        {
             auto ret = SkywellTrust::makeItem (accountID, sleCur);
