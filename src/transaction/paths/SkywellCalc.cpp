...
SkywellCalc::Output SkywellCalc::truechainCalculate (
    ...
    Input const* const pInputs)
{
    ...
    auto result = rc.truechainCalculate ();
    Output output;
...
TER SkywellCalc::truechainCalculate ()
{
    ...
    {
        WriteLog (lsDEBUG, SkywellCalc)
            << "truechainCalc: Invalid transaction:"
            << "No paths and direct truechain not allowed.";
    ...
    WriteLog (lsTRACE, SkywellCalc)
        << "truechainCalc: Paths in set: " << spsPaths_.size ();
