...
#ifndef SKYWELL_APP_PATHS_NODE_H_INCLUDED
#define SKYWELL_APP_PATHS_NODE_H_INCLUDED
...
struct Node
{
    ...
    // "quality".
    // https://skywell.com/wiki/Ledger_Format#Prioritizing_a_continuous_key_space
