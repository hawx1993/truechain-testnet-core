...
#ifndef SKYWELL_APP_PATHS_SKYWELLCALC_H_INCLUDED
#define SKYWELL_APP_PATHS_SKYWELLCALC_H_INCLUDED
...
/** SkywellCalc calculates the quality of a payment path.
...
public:
    ...
    static Output truechainCalculate (
