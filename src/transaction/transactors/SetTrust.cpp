    ...
    TER doApply () override
    {
        ...
        if (sleSkywellState)
        {
            ...
            else
            {
                ...
                m_journal.trace << "Modify truechain line";
            }
        }
        // Line does not exist.
        ...
        {
            m_journal.trace <<
                "Redundant: Setting non-existent truechain line to defaults.";
        ...
        else
        {
            ...
            m_journal.trace <<
                "doTrustSet: Creating truechain line: " <<
                to_string (index);

            // Create a new truechain line.
