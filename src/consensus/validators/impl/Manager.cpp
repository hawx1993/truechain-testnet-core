...
/** ChosenValidators (formerly known as UNL)
    ...
    independently sign LedgerHash objects with their SkywellPublicKey. These
    ...
    In order that truechain administrators may publish their ChosenValidators
    ...
    TODO:
      ...
      Template: https://truechain.com/wiki/Federation_protocol
      - What to do if you're a publisher of ValidatorList
      - What to do if you're a truechain administrator
      - Overview of how ChosenValidators works

    Goals:
      Make default configuration of truechain secure.
    ...
    What we want from the unique node list:
      ...
      - Skywelld will ship with a list of trusted root "certificates"
