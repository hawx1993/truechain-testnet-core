...
#ifndef SKYWELL_VALIDATORS_CONNECTIONIMP_H_INCLUDED
#define SKYWELL_VALIDATORS_CONNECTIONIMP_H_INCLUDED
...
private:
    ...
    using Item = std::pair<LedgerHash, SkywellAddress>;
    ...
    boost::container::flat_map<SkywellAddress, Source> sources_;
    boost::container::flat_set<SkywellAddress> good_;
...
public:
    ...
    onLedger (LedgerHash const& ledger)
    {
        ...
        auto item = items_.lower_bound(
            std::make_pair(ledger, SkywellAddress()));
