...
/** Config: SKYWELL_VERIFY_NODEOBJECT_KEYS
    This verifies that the hash of node objects matches the payload.
    It is quite expensive so normally this is turned off!
*/
#ifndef   SKYWELL_VERIFY_NODEOBJECT_KEYS
//#define SKYWELL_VERIFY_NODEOBJECT_KEYS 1
#endif

/** Config: SKYWELL_DUMP_LEAKS_ON_EXIT
    Displays heap blocks and counted objects which were not disposed of
    during exit.
*/
#ifndef SKYWELL_DUMP_LEAKS_ON_EXIT
#define SKYWELL_DUMP_LEAKS_ON_EXIT 1
#endif

//------------------------------------------------------------------------------

// These control whether or not certain functionality gets
// compiled into the resulting skywelld executable

/** Config: SKYWELL_ROCKSDB_AVAILABLE
    Controls whether or not the RocksDB database back-end is compiled into
    skywelld. RocksDB requires a relatively modern C++ compiler (tested with
...
// is being written.
//
#ifndef SKYWELL_USE_VALIDATORS
#define SKYWELL_USE_VALIDATORS 0
#endif
...
/** Config: SKYWELL_PROPOSE_FEATURES
    This determines whether to add any features to the proposed transaction set.
*/
#ifndef SKYWELL_PROPOSE_AMENDMENTS
#define SKYWELL_PROPOSE_AMENDMENTS 0
#endif

/** Config: SKYWELL_SINGLE_IO_SERVICE_THREAD
    When set, restricts the number of threads calling io_service::run to one.
    This is useful when debugging.
*/
#ifndef SKYWELL_SINGLE_IO_SERVICE_THREAD
#define SKYWELL_SINGLE_IO_SERVICE_THREAD 0
#endif

/** Config: SKYWELL_HOOK_VALIDATORS
    Activates code for handling validations and validators (work in progress).
*/
#ifndef SKYWELL_HOOK_VALIDATORS
#define SKYWELL_HOOK_VALIDATORS 0
#endif

/** Config: SKYWELL_ENABLE_TICKETS
    Enables processing of ticket transactions
*/
#ifndef SKYWELL_ENABLE_TICKETS
#define SKYWELL_ENABLE_TICKETS 0
#endif
