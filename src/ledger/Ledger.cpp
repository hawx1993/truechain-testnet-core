...
Ledger::Ledger (SkywellAddress const& masterID, std::uint64_t startAmount)
...
bool Ledger::hasAccount (SkywellAddress const& accountID) const
{
...
AccountState::pointer Ledger::getAccountState (SkywellAddress const& accountID) const
{
...
//getnicknamenode
AccountState::pointer Ledger::getAccountState1(const SkywellAddress & accountID) const
{
...
SLE::pointer Ledger::getAccountRoot (SkywellAddress const& naAccountID) const
{
...
SLE::pointer
Ledger::getSkywellState (uint256 const& uNode) const
{
    return getASNodeI (uNode, ltSKYWELL_STATE);
}

SLE::pointer
Ledger::getSkywellState (
    Account const& a, Account const& b, Currency const& currency) const
{
    return getSkywellState (getSkywellStateIndex (a, b, currency));
}
