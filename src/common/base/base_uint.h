...
#ifndef SKYWELL_BASICS_BASE_UINT_H_INCLUDED
#define SKYWELL_BASICS_BASE_UINT_H_INCLUDED
...
template <std::size_t Bits, class Tag>
struct hash<truechain::base_uint<Bits, Tag>>
{
    using argument_type = truechain::base_uint<Bits, Tag>;

    std::size_t
    operator()(argument_type const& u) const
    {
        return truechain::hardened_hash<>{}(u);
    }
};
