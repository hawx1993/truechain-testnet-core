...
#ifndef SKYWELL_BASICS_LOG_H_INCLUDED
#define SKYWELL_BASICS_LOG_H_INCLUDED
...
#define ShouldLog(s, k) \
    ::truechain::deprecatedLogs()[#k].active(::truechain::Logs::toSeverity (s))

#define WriteLog(s, k)                                              \
    if (!ShouldLog(s, k))                                           \
        do {} while (0);                                            \
    else                                                            \
        ::beast::Journal::Stream (::truechain::deprecatedLogs()[#k],   \
                                  ::truechain::Logs::toSeverity(s))
