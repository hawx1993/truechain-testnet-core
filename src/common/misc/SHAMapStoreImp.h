...
#ifndef SKYWELL_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define SKYWELL_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
private:
    ...
    std::string const dbPrefix_ = "truechaindb";
...
private:
    ...
    // If truechain is not healthy, defer rotate-delete.
