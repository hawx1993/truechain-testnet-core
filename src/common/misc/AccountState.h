...
#ifndef SKYWELL_APP_MISC_ACCOUNTSTATE_H_INCLUDED
#define SKYWELL_APP_MISC_ACCOUNTSTATE_H_INCLUDED
...
public:
    // For new accounts
    explicit AccountState (SkywellAddress const& naAccountID);

    // For accounts in a ledger
    AccountState (SLE::ref ledgerEntry, SkywellAddress const& naAccountI);
    ...
    SkywellAddress getAuthorizedKey ()
    {
...
private:
    SkywellAddress const mAccountID;
    SkywellAddress                  mAuthorizedKey;
