...
int main (int argc, char** argv)
{
    ...
    static_assert (gccver >= 40801,
        "GCC version 4.8.1 or later is required to compile truechain.");
#endif

    static_assert (BOOST_VERSION >= 105700,
        "Boost version 1.57 or later is required to compile truechain");
    ...
    auto const result (truechain::run (argc, argv));
